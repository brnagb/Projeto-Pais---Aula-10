...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <title>projeto.pais - Alterar Pais</title>
                    ...
                    <form action="controller.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="nome" id="nome" required maxlength="100" placeholder="digite o nome de um pais" value="${pais.nome }">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="area">Area</label>
                                <input type="number" class="form-control" name="area" id="area" required maxlength="60" value="${pais.area}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="populacao">Populacão</label>
